...
var TwitterFeeder = function(twitterAPI){
...
TwitterFeeder.prototype.endStream = function() {
	this.twitterStream.removeAllListeners('data');
	this.twitterStream.removeAllListeners('error');
...
TwitterFeeder.prototype.search = function(placeName, lat, lng) {
	...
	this.twitterAPI.stream('statuses/filter',
