...
var Client = function(twitterAPI) {
...
Client.prototype.searchPrevious = function(placeName, lat, lng){		
	...
	var self = this;
	var twitterSearcher = new TwitterSearcher(this.twitterAPI);
	
	twitterSearcher.on("tweets", function(tweets){			
		self.checkAllPreviousResultsReady(tweets);	
	});
	
	twitterSearcher.on("noTweets", function(){			
		self.checkAllPreviousResultsReady([]);	
	});
...
Client.prototype.startTwitterStream = function(placeName, lat, lng){		
	var self = this;
	this.twitterFeeder = new TwitterFeeder(this.twitterAPI);	
